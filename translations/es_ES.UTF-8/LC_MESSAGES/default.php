<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this AzuraCast installation. Separate multiple domain names with commas.' => 'Todos los nombres de dominio listados deben apuntar a esta instalación de Simona Music. Separa varios nombres de dominio con comas.',
      ...
      'AzuraCast First-Time Setup' => 'Configuración Inicial de Simona Music',
      'AzuraCast Instance Name' => 'Nombre de instancia de Simona Music',
      'AzuraCast ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'Simona Music incluye una base de datos de geolocalización IP gratuita. Es posible que prefiera utilizar el servicio MaxMind GeoLite en su lugar para obtener resultados más precisos. El uso de MaxMind GeoLite requiere una clave de licencia, pero una vez proporcionada la clave, mantendremos la base de datos actualizada automáticamente.',
      'AzuraCast Update Checks' => 'Comprobaciones de Actualización de Simona Music',
      'AzuraCast User' => 'Usuario de Simona Music',
      'AzuraCast uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'Simona Music utiliza un sistema de control de acceso basado en roles. Los roles reciben permisos para ciertas secciones del sitio, luego los usuarios son asignados a esos roles.',
      'AzuraCast Wiki' => 'Wiki de Simona Music',
      'AzuraCast will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'Simona Music escaneará el archivo subido en busca de coincidencias en la biblioteca de música de esta estación. Los medios deben ser cargados antes de ejecutar este paso. Puede volver a ejecutar esta herramienta tantas veces como sea necesario.',
      ...
      'Powered by AzuraCast' => 'Desarrollado por Simona Music',
      ...
      'Update' => 'Actualizar',
      'Update AzuraCast' => 'Actualizar Simona Music',
      'Update AzuraCast via Web' => 'Actualizar Simona Music vía Web',
      'Update AzuraCast? Your installation will restart.' => '¿Actualizar Simona Music? Su instalación se reiniciará.',
      ...
      'Use' => 'Uso',
      'Use (Us)' => 'Uso (Us)',
      'Use API keys to authenticate with the AzuraCast API using the same permissions as your user account.' => 'Utilice las claves API para autenticarse con la API de Simona Music usando los mismos permisos que su cuenta de usuario.',
      ...
      'AzuraCast Application Log' => 'Log de aplicación de Simona Music',
      'AzuraCast Now Playing Log' => 'Registro de Reproducción en Curso de Simona Music',
      'AzuraCast Synchronized Task Log' => 'Registro de Tarea Sincronizada de Simona Music',
      'AzuraCast Queue Worker Log' => 'Registro de Trabajadores de Cola de Simona Music',
      ...
      'New AzuraCast Rolling Release Available' => 'Disponible Nueva Versión de Simona Music',
      ...
      'You can track the execution time and memory usage of any AzuraCast page or application from the profiler page.' => 'Puede rastrear el tiempo de ejecución y el uso de la memoria de cualquier página o aplicación de Simona Music desde la página del generador de perfiles.',
