        ...
        >
            <div class="card-body">
                <form-fieldset>
                    ...
                    <ul>
                        <li>
                            Simona Music assumes that your station fits SoundExchange Transmission Category A, "Eligible
                        ...
                        <li>
                            The data collected by Simona Music meets the SoundExchange standard for Actual Total
                        ...
                        <li>
                            Reporting requirements for SoundExchange may change at any time. Simona Music is non-commercial
                            community-built software and cannot guarantee that its reporting format will always be
                            up-to-date.
                        </li>
                        <li>
                            You should always verify the report generated by Simona Music before sending it. In particular,
                ...
                <form-fieldset class="row">
                    ...
                    >
                        ...
                        <template #description>
                            {{
                                $gettext('If enabled, Simona Music will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.')
                            }}
                        </template>
                    </form-group-checkbox>
                </form-fieldset>
